/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc034fd194373b1bed26971ccbb73f9b)
// Runtime types generated with workerd@1.20260811.1 2026-08-18 nodejs_compat
interface __BaseEnv_Env {
	VERCEL_AI_GATEWAY_API_KEY: string;
	EXTERNAL_SERVICE: Fetcher /* recourt-external-service */;
	INTERNAL_SERVICE: Fetcher /* recourt-internal */;
	STORE_ARTICLE: Workflow<Parameters<import("./src/main").StoreArticleWorkflow['run']>[0]['payload']>;
	EXTRACT_CASE: Workflow<Parameters<import("./src/main").ExtractCaseWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VERCEL_AI_GATEWAY_API_KEY">> {}
}
