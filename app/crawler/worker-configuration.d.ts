/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a740015ee3664c279ab25baa5438cd5b)
...
interface __BaseEnv_Env {
	...
	CRAWL_SEARCH: Workflow<Parameters<import("./src/main").CrawlSearchWorkflow['run']>[0]['payload']>;
	CRAWL_CASE: Workflow<Parameters<import("./src/main").CrawlCaseWorkflow['run']>[0]['payload']>;
}
